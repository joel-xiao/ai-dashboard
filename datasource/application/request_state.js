...
export default {
  id: 'datasource-application-states',
    ...
    if (ret?.result === 'ok') {
      ret.data.forEach(r => {
        ...
        result.push({
          ...
          exception_rate: p.numToFixed(r.exception_rate * 100, 1) + '%',
          err: r.err,
          fail: r.fail,
          slow: r.slow,
          ...
          err_4xx_rate: p.numToFixed(r.err_4xx_rate * 100, 1) + '%',
          err_5xx_rate: p.numToFixed(r.err_5xx_rate * 100, 1) + '%',
